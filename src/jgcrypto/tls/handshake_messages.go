...
func (m *clientHelloMsg) marshal() []byte {
	...
	// Force inclusion of the NPN extension even if it is
	// missing. This is done so that the remote will respond with a
	// list of protocols.
	
	if m.nextProtoNeg || true {
		numExtensions++
	}
	if m.ocspStapling {
	...
	// Always add the NPN extension (see comment above)
